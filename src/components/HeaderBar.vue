<template>
 ...
 <nav class="nav-bar flex justify-between px-10 py-4 items-center flex-col md:flex-row border-b border-search-color">
      <div class="left-items">
        <ul class="flex text-white items-center justify-between space-x-4 flex-col md:flex-row">
          <li class="mx-6"><a href="https://movies.andredemos.ca">
          ...
          <li class=""><a href="http://127.0.0.1:5173" class="hover:text-hover">Movies</a></li>
          <li class=""><a href="TV" class="hover:text-hover">TV Shows</a></li>
          <li class=""><a href="actors" class="hover:text-hover">Actors</a></li>

        </ul>
      </div>
      <div class="right-item flex items-center md:flex-row flex-col">
        <div class="search-bar w-64 relative ">
          <input placeholder="Search (press '/' to focus)"
            class="bg-search-color rounded-xl w-64 px-8 py-0.5 text-sm" />
